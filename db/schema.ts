...
export const catalogProducts = sqliteTable("catalog_products", {
  ...
  vehicleMake: text("vehicle_make").notNull().default("TOYOTA"),
  vehicleModel: text("vehicle_model").notNull(),
  modelNumber: text("model_number").notNull().default(""),
  category: text("category").notNull().default("Shock Absorber"),
  position: text("position").notNull().default("Full Set"),
